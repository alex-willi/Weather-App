...
<       div className='sevenData'>
        <div className="day1" style={{border: '1px solid black', borderColor: 'rgba(0, 0, 0, .2)'}}>
    ...
    <div className="day2" style={{border: '1px solid black',borderColor: 'rgba(0, 0, 0, .2)'}}>
    ...
    <div className="day3" style={{border: '1px solid black',borderColor: 'rgba(0, 0, 0, .2)'}}>
    ...
    <div className="day4" style={{border: '1px solid black',borderColor: 'rgba(0, 0, 0, .2)'}}>
   ...
   <div className="day5" style={{border: '1px solid black',borderColor: 'rgba(0, 0, 0, .2)'}}>
   ...
   <div className="day6" style={{border: '1px solid black',borderColor: 'rgba(0, 0, 0, .2)'}}>
   ...
   <div className="day7" style={{border: '1px solid black',borderColor: 'rgba(0, 0, 0, .2)'}}>
